...
Version: v20260323a   # Date rollover to March 23, 2026 - first version of the day
"""
...
def download_http(url, target_path, expected_bytes, downloaded):
    ...
    for attempt in range(retries):
        try:
            ...
            print(f"  HTTP attempt {attempt+1}/{retries} (range: {range_header or 'full'})")
            ...
            if e.response.status_code == 416:
                ...
                downloaded = 0  # reset to full
                if os.path.exists(target_path):
                    os.remove(target_path)  # start fresh
                continue
