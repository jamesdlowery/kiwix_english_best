...
Version: v20260323e   # FIXED: uppercase '-C' for zimcheck + .partial suffix stripped on corrupt move
"""
...
def verify_zim_integrity(target_path, filename):
    ...
    # Strip .partial suffix for the final corrupt name
    base_name = filename
    ...
    try:
        result = subprocess.run(
            ['zimcheck', '-C', target_path],  # uppercase -C for checksum
            capture_output=True,
            text=True,
            timeout=300
        )
