...
Version: v20260325k   # FIXED: Total progress bar now reliably appears after each batch in verbose mode
"""
    ...
    try:
        ...
        with ThreadPoolExecutor(max_workers=MAX_CONCURRENT_DOWNLOADS) as executor:
            ...
            for future in as_completed(futures):
                ...
                # === KEY FIX FOR VERBOSE MODE ===
                # Force the total progress bar to print after each completed task
                if verbose and time.time() - last_force > 0.3:   # debounce to avoid excessive flicker
                    print(pbar_total)
                    last_force = time.time()
