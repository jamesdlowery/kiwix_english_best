...
Version: v20260323c   # Timeout hardening + subfolder output + parallel downloads (max 4 concurrent)
"""
...
ZIM_SUBFOLDER = "zims"  # all .zim files go here
CHUNK_SIZE = 1024 * 1024  # 1 MiB
TORRENT_CHECK_TIMEOUT = 10
HTTP_TIMEOUT = 120  # increased for robustness
HTTP_RETRIES = 3
...
def download_http(url, target_path, expected_bytes, downloaded):
    ...
    backoff = [5, 10, 20]  # exponential backoff
    ...
    for attempt in range(retries):
        try:
            ...
            tolerance = max(1024 * 1024, expected_bytes // 200)  # 1 MiB min or 0.5%
