...
#
# Changes in this version (remove deflated {remaining} from progress bar):
#
# FIX 11 -- Removed {remaining} from bar_format. tqdm computes {remaining} as
#   (total - n) / internal_rate; since internal_rate is derived from pbar.n
#   which includes the partial-file baseline, {remaining} was grossly deflated
#   (e.g. showing <15:28 when the true remaining time was ~55 hours). The field
#   is now absent entirely -- {elapsed} is kept (always honest) and our custom
#   ETA= postfix is the sole remaining-time estimate shown.
#   Example output: "46%|█████▊| 279G/609G [13:05, 1.71 MiB/s, ETA=54:41:56]"
#
