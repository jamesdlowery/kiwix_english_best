...
def confirm_proceed(required_gb, available_gb):
    ...
    print(f"  Available on zims: ~{available_gb:.1f} GB")
...
# - Restored missing get_free_space_gb() function to fix NameError
# - Added explicit exemption for wiktionary_en_all_nopic_* (the only comprehensive English version)
# - All other _nopic_ files are still dropped
# - Wikipedia limited strictly to wikipedia_en_all_maxi_*
# - Gutenberg limited to single _all_ file
# 
# This is the production-ready version with all requested exclusions and Wiktionary exception.
