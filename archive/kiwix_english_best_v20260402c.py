...
RESUME_FILE = "kiwix_resume.txt"   # written by option 3 when downloads are incomplete
...
#
# Changes in this version (resume file for incomplete option 3 downloads):
#
# FIX 47 -- Option 3 now writes a resume file (kiwix_resume.txt) after a
...
#   the next option 2 run, if kiwix_resume.txt exists the user is offered the
...
#   New constant: RESUME_FILE = "kiwix_resume.txt"
#
