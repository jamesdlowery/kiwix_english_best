...
# ==================== LIVE TOTAL BAR WITH BYTE-BASED ETA ====================
def total_bar_refresh_thread(pbar, total_expected, stop_event, verbose):
    ...
    while not stop_event.is_set():
        ...
        # Force update the bar with current downloaded bytes
...
# - Total progress bar forced to update on every refresh cycle from actual bytes
# - Reliable byte-based ETA with clean HH:MM:SS format after ~5 seconds
# - Smoother integration to reduce overwriting by torrent lines
# - Faster refresh (1s) for better responsiveness in verbose mode
# 
# The Total progress should now advance smoothly and show a stable ETA.
