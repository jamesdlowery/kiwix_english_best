...
Version: v20260325m   # FIXED: Strict binary (1024-based) size handling with correct KiB/MiB/GiB/TiB labels
"""
...
def bytes_to_binary_human(b):
    """Strict binary (1024-based) with correct KiB/MiB/GiB/TiB labels"""
    if b == 0:
        return "0 B"
