...
def main():
    ...
    print("3) Check for updates (based on zims/ folder; includes new groups + auto-cleanup)")
...
#
# Changes in this version (option 3 uses zims/ as baseline; new option 4 cleanup):
#
