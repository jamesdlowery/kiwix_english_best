...
Version: v20260324d   # Fixed refinement order: language → subcategory tree → best-per-group selection
"""
...
LANGUAGE_PATTERNS = {
    'en': r'_en_|_english|english\.', 'fr': r'_fr_|_french|french\.', 'es': r'_es_|_spanish|spanish\.',
    'de': r'_de_|_german|german\.', 'it': r'_it_|_italian|italian\.', 'pt': r'_pt_|_portuguese|portuguese\.',
    'ru': r'_ru_|_russian|russian\.', 'zh': r'_zh_|_chinese|chinese\.', 'ja': r'_ja_|_japanese|japanese\.',
    'ko': r'_ko_|_korean|korean\.', 'ar': r'_ar_|_arabic|arabic\.',
    # Expanded ISO codes for Wiktionary, Wikibooks, etc.
    'af': r'_af_', 'am': r'_am_', 'ang': r'_ang_', 'ast': r'_ast_', 'ay': r'_ay_', 'az': r'_az_',
    'ba': r'_ba_', 'be': r'_be_', 'bg': r'_bg_', 'bn': r'_bn_', 'bo': r'_bo_', 'br': r'_br_',
    'bs': r'_bs_', 'ca': r'_ca_', 'ce': r'_ce_', 'ckb': r'_ckb_', 'cs': r'_cs_', 'cv': r'_cv_',
    'cy': r'_cy_', 'da': r'_da_', 'diq': r'_diq_', 'dsb': r'_dsb_', 'dv': r'_dv_', 'el': r'_el_',
    'eo': r'_eo_', 'et': r'_et_', 'eu': r'_eu_', 'fa': r'_fa_', 'fi': r'_fi_', 'fo': r'_fo_',
    'fy': r'_fy_', 'ga': r'_ga_', 'gd': r'_gd_', 'gl': r'_gl_', 'gn': r'_gn_', 'got': r'_got_',
    'gu': r'_gu_', 'gv': r'_gv_', 'ha': r'_ha_', 'he': r'_he_', 'hi': r'_hi_', 'hsb': r'_hsb_',
    'hu': r'_hu_', 'hy': r'_hy_', 'ia': r'_ia_', 'id': r'_id_', 'ie': r'_ie_', 'ig': r'_ig_',
    'ilo': r'_ilo_', 'io': r'_io_', 'is': r'_is_', 'jv': r'_jv_', 'ka': r'_ka_', 'kk': r'_kk_',
    'kl': r'_kl_', 'km': r'_km_', 'kn': r'_kn_', 'ku': r'_ku_', 'kv': r'_kv_', 'kw': r'_kw_',
    'ky': r'_ky_', 'la': r'_la_', 'lb': r'_lb_', 'li': r'_li_', 'lmo': r'_lmo_', 'ln': r'_ln_',
    'lo': r'_lo_', 'lt': r'_lt_', 'lv': r'_lv_', 'mg': r'_mg_', 'mi': r'_mi_', 'mk': r'_mk_',
    'ml': r'_ml_', 'mn': r'_mn_', 'mr': r'_mr_', 'ms': r'_ms_', 'mt': r'_mt_', 'my': r'_my_',
    'na': r'_na_', 'nah': r'_nah_', 'nap': r'_nap_', 'nds': r'_nds_', 'ne': r'_ne_', 'new': r'_new_',
    'nl': r'_nl_', 'nn': r'_nn_', 'no': r'_no_', 'nov': r'_nov_', 'oc': r'_oc_', 'or': r'_or_',
    'os': r'_os_', 'pa': r'_pa_', 'pdc': r'_pdc_', 'pms': r'_pms_', 'pnb': r'_pnb_', 'pl': r'_pl_',
    'ps': r'_ps_', 'qu': r'_qu_', 'rm': r'_rm_', 'ro': r'_ro_', 'rw': r'_rw_', 'sa': r'_sa_',
    'sc': r'_sc_', 'sco': r'_sco_', 'sd': r'_sd_', 'se': r'_se_', 'sh': r'_sh_', 'si': r'_si_',
    'sk': r'_sk_', 'sl': r'_sl_', 'so': r'_so_', 'sq': r'_sq_', 'sr': r'_sr_', 'srn': r'_srn_',
    'su': r'_su_', 'sv': r'_sv_', 'sw': r'_sw_', 'ta': r'_ta_', 'te': r'_te_', 'tg': r'_tg_',
    'th': r'_th_', 'ti': r'_ti_', 'tk': r'_tk_', 'tl': r'_tl_', 'tn': r'_tn_', 'to': r'_to_',
    'tpi': r'_tpi_', 'tr': r'_tr_', 'ts': r'_ts_', 'tt': r'_tt_', 'tum': r'_tum_', 'tw': r'_tw_',
    'ty': r'_ty_', 'ug': r'_ug_', 'uk': r'_uk_', 'ur': r'_ur_', 'uz': r'_uz_', 've': r'_ve_',
    'vi': r'_vi_', 'vo': r'_vo_', 'wa': r'_wa_', 'war': r'_war_', 'wo': r'_wo_', 'xal': r'_xal_',
    'xh': r'_xh_', 'yi': r'_yi_', 'yo': r'_yo_', 'za': r'_za_', 'zea': r'_zea_', 'zu': r'_zu_',
}
...
def detect_language(filename):
    ...
    for lang, pattern in LANGUAGE_PATTERNS.items():
        if re.search(pattern, fn):
            return lang
    # Fallback for any 2-3 letter code in common position
...
def main():
    ...
    if choice == "1":
        ...
        # Language + Subcategory refinement BEFORE best-per-group selection
