...
# - Reliable byte-based ETA with clean HH:MM:SS format after ~3 seconds
# - Smoother integration and locking to reduce overwriting by torrent lines
# - Faster refresh (0.8s) for better responsiveness in verbose mode
# 
