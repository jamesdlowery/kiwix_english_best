...
Version: v20260323h   # ADDED: mirror rotation on HTTP timeout/error
"""
...
def download_single(item, file_index, total_files):
    ...
    if not success:
        ...
        success = download_http(base_url, partial_path, expected_bytes, downloaded)
...
def download_http(original_url, target_path, expected_bytes, downloaded):
    ...
    backoff = [5, 10, 20]
    mirror_index = 0  # Start with primary mirror
