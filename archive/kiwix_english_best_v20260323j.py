...
Version: v20260323j   # March 23, 2026 - tenth increment of the day
"""
...
# Mirror rotation list (used on timeout/error)
MIRRORS = [
...
def extract_group_key(fn):
    ...
    # Strip variant suffixes to group related files together
...
def select_best_per_group(all_files):
    ...
    for key, files in sorted(groups.items()):
        ...
        # Sort: largest size first, then newest date, then alphabetical
...
def download_http(original_url, target_path, expected_bytes, downloaded):
