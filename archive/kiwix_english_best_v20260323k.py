...
Version: v20260323k   # ADDED: quiet/verbose prompt + unified progress line every 5s in quiet mode
"""
...
PROGRESS_UPDATE_INTERVAL = 5  # seconds between unified progress lines in quiet mode
