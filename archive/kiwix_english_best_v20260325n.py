...
Version: v20260325n   # ENHANCED: Smart best-per-group selection with _all_maxi_ > _all_ priority + speedtest exclusion
"""
...
def get_selection_priority(filename):
    ...
    if '_mini_' in fn or '_nopic' in fn or '_nopics' in fn or '_lite' in fn:
        return 50
    return 100  # default for splits / topic-specific
...
def select_best_per_group(all_files):
    ...
    for key, files in sorted(groups.items()):
        ...
        # Sort by: priority (desc), size (desc), date (desc)
...
# ==================== SAVE / LOAD / STATE (updated human display) ====================
...
# (load_list, save_state, load_state, verify_zim_integrity, download_single, download_http, download_torrent remain unchanged from v20260325m)
