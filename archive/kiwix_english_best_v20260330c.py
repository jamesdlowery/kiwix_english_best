...
#
# Changes in this version (add seeds/peers ratio and distributed_copies display):
#
# FIX 18 -- download_torrent: 'method' field updated to show seeds as a
#   fraction of total peers ("Seeds: N/N") and add s.distributed_copies,
#   which indicates piece availability across the swarm. A value below 1.0
#   means some pieces exist on fewer than one peer on average -- a strong
#   indicator of why download speed is low. Values at or above 1.0 indicate
#   a reasonably healthy swarm.
#   Example: "Seeds: 3/16 | Copies: 0.72" vs the old "Seeds: 3 | Peers: 16".
#
...
#   FIX 17 -- seeds and peers shown separately (superseded by FIX 18)
