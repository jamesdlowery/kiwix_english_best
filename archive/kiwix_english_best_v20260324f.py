...
Version: v20260324f   # Full language names (alphabetical) + comprehensive ISO mapping
"""
...
LANGUAGE_MAP = {
    ...
    'zu': 'Zulu',
    # Additional codes from your list
    'ab': 'Abkhazian', 'ace': 'Achinese', 'ady': 'Adyghe', 'ak': 'Akan', 'ale': 'Aleut',
    'an': 'Aragonese', 'anp': 'Angika', 'arc': 'Aramaic', 'arp': 'Arapaho', 'ary': 'Moroccan Arabic',
    'arz': 'Egyptian Arabic', 'as': 'Assamese', 'atj': 'Atikamekw', 'av': 'Avaric', 'avk': 'Kotava',
    'awa': 'Awadhi', 'azb': 'South Azerbaijani', 'ban': 'Balinese', 'bar': 'Bavarian',
    'bcl': 'Central Bikol', 'bgs': 'Tagabawa', 'bho': 'Bhojpuri', 'bi': 'Bislama',
    'bjn': 'Banjar', 'blk': 'Pa-O', 'bm': 'Bambara', 'bpy': 'Bishnupriya', 'brx': 'Bodo',
    'bug': 'Buginese', 'bxr': 'Russia Buriat', 'cbk': 'Chavacano', 'cdo': 'Min Dong Chinese',
    'ceb': 'Cebuano', 'ch': 'Chamorro', 'chr': 'Cherokee', 'chy': 'Cheyenne', 'co': 'Corsican',
    'cr': 'Cree', 'crh': 'Crimean Tatar', 'csb': 'Kashubian', 'cu': 'Church Slavic',
    'dag': 'Dagbani', 'din': 'Dinka', 'dty': 'Dotyali', 'dz': 'Dzongkha', 'ee': 'Ewe',
    'eml': 'Emilian', 'enm': 'Middle English', 'ext': 'Extremaduran', 'far': 'Farsi',
    'fas': 'Persian', 'fat': 'Fanti', 'ff': 'Fulah', 'fj': 'Fijian', 'fon': 'Fon',
    'frp': 'Franco-Provençal', 'frr': 'Northern Frisian', 'fur': 'Friulian', 'gag': 'Gagauz',
    'gan': 'Gan Chinese', 'gcr': 'Guianese Creole', 'gla': 'Scottish Gaelic', 'gle': 'Irish',
    'glk': 'Gilaki', 'gom': 'Goan Konkani', 'gor': 'Gorontalo', 'grc': 'Ancient Greek',
    'gsw': 'Swiss German', 'guc': 'Wayuu', 'gur': 'Frafra', 'guw': 'Gun', 'hak': 'Hakka Chinese',
    'haw': 'Hawaiian', 'hif': 'Fiji Hindi', 'hr': 'Croatian', 'ht': 'Haitian', 'hyw': 'Western Armenian',
    'ik': 'Inupiaq', 'inh': 'Ingush', 'iu': 'Inuktitut', 'jam': 'Jamaican Creole English',
    'jbo': 'Lojban', 'kaa': 'Kara-Kalpak', 'kab': 'Kabyle', 'kbd': 'Kabardian', 'kbp': 'Kabiye',
    'kcg': 'Tyap', 'kg': 'Kongo', 'kha': 'Khasi', 'ki': 'Kikuyu', 'kld': 'Gamilaraay',
    'koi': 'Komi-Permyak', 'krc': 'Karachay-Balkar', 'ks': 'Kashmiri', 'ksh': 'Kölsch',
    'lad': 'Ladino', 'lbe': 'Lak', 'lbj': 'Ladakhi', 'lez': 'Lezghian', 'lfn': 'Lingua Franca Nova',
    'lg': 'Ganda', 'lij': 'Ligurian', 'lld': 'Ladin', 'ltg': 'Latgalian', 'lzh': 'Literary Chinese',
    'mad': 'Madurese', 'mai': 'Maithili', 'mdf': 'Moksha', 'mhr': 'Eastern Mari', 'min': 'Minangkabau',
    'mni': 'Manipuri', 'mnw': 'Mon', 'mrj': 'Western Mari', 'mul': 'Multiple languages',
    'mwl': 'Mirandese', 'myv': 'Erzya', 'mzn': 'Mazanderani', 'nan': 'Min Nan Chinese',
    'nav': 'Navajo', 'nb': 'Norwegian Bokmål', 'nia': 'Nias', 'nqo': 'N’Ko', 'nrf': 'Norman',
    'nso': 'Northern Sotho', 'nv': 'Navajo', 'ny': 'Nyanja', 'oj': 'Ojibwa', 'olo': 'Livvi-Karelian',
    'om': 'Oromo', 'pag': 'Pangasinan', 'pam': 'Pampanga', 'pap': 'Papiamento', 'pcd': 'Picard',
    'pcm': 'Nigerian Pidgin', 'pfl': 'Palatine German', 'pi': 'Pali', 'pih': 'Pitcairn-Norfolk',
    'pnt': 'Pontic', 'pr': 'Pirahã', 'pwn': 'Paiwan', 'rmq': 'Caló', 'rmy': 'Vlax Romani',
    'rn': 'Rundi', 'roa': 'Romance languages', 'ron': 'Romanian', 'rue': 'Rusyn', 'rup': 'Aromanian',
    'sah': 'Yakut', 'sat': 'Santali', 'scn': 'Sicilian', 'sg': 'Sango', 'sgs': 'Samogitian',
    'shi': 'Tachelhit', 'shn': 'Shan', 'skr': 'Saraiki', 'sm': 'Samoan', 'smn': 'Inari Sami',
    'sn': 'Shona', 'ss': 'Swati', 'st': 'Southern Sotho', 'stq': 'Saterland Frisian',
    'szl': 'Silesian', 'szy': 'Sakizaya', 'tay': 'Atayal', 'tcy': 'Tulu', 'tet': 'Tetum',
    'trv': 'Taroko', 'tyv': 'Tuvinian', 'udm': 'Udmurt', 'ug': 'Uyghur', 'uzb': 'Uzbek',
    'vec': 'Venetian', 'vep': 'Veps', 'vls': 'West Flemish', 'vro': 'Võro', 'wuu': 'Wu Chinese',
    'xmf': 'Mingrelian', 'yue': 'Cantonese', 'zea': 'Zealandic', 'zgh': 'Standard Moroccan Tamazight',
}
